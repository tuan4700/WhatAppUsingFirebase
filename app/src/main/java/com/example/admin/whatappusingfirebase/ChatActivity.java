...
public class ChatActivity extends AppCompatActivity {
    private String messageReceiverID, messageReceiverName, messageReceiverImage, messageSenderID, messageSenderState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageSenderState = getIntent().getExtras().get("visit_state").toString();
    ...
    private void init() {
        ...
        //....set Trang thai
        userLastSeen.setText(messageSenderState);
        //... set Trang thai
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==438 && resultCode==RESULT_OK && data!=null &&data.getData()!=null)
        {
            ...
            else if (!checker.equals("image"))
            {
                ...
                final String messageSendRef = "Messages/" + messageSenderID + "/" + messageReceiverID;
    ...
    //................Cap nhat trang thai tren thanh status bar...................//
